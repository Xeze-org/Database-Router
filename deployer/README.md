...
| Component | Endpoint |
|---|---|
| Web UI (Caddy HTTPS) | `https://db.0.xeze.org` |
| gRPC (Caddy HTTPS) | `grpc.db.0.xeze.org:443` |
...
- **Firewall**: auto-detects your public IP and restricts SSH/gRPC/WebUI to it
